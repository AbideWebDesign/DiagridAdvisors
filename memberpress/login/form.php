<?php if(!defined('ABSPATH')) {die('You are not allowed to call this page directly.');} ?>
					...
					<div class="mp_wrapper mp_login_form p-lg-5 m-lg-5">
					  ...
					  <?php else: ?>
					    ...
					    <form name="mepr_loginform" id="mepr_loginform" class="mepr-form" action="<?php echo $login_url; ?>" method="post">
					      ...
					      <div class="mp-form-row mepr_username">
					        ...
					        <input type="text" name="log" id="user_login" placeholder="Email Address" value="<?php echo (isset($_REQUEST['log'])?esc_html($_REQUEST['log']):''); ?>" />
					      </div>
					      ...
					      <div class="submit">
					        <input type="submit" name="wp-submit" id="wp-submit" class="btn btn-primary" value="<?php _ex('Log In', 'ui', 'memberpress'); ?>" />
