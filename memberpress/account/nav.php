...
<div class="bg-primary text-white mb-4">
	...
	<div id="mepr-account-nav" class="d-flex mb-0">
		...
		<div class="d-flex mepr-nav-item">
			
			<a href="<?php echo MeprUtils::logout_url(); ?>" id="mepr-account-logout"><?php _ex('Logout', 'ui', 'memberpress'); ?></a>
