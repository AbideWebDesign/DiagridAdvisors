...
-->
    ...
    <?php else: ?>
      ...
      <div class="mp-form-row mepr_email">
        ...
        <input type="email" name="user_email" placeholder="Email" id="user_email<?php echo $unique_suffix; ?>" class="mepr-form-input" value="<?php echo (isset($user_email))?esc_attr(stripslashes($user_email)):''; ?>" required />
      </div>
