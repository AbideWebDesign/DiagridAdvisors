		  ...
		  <form class="mepr-signup-form mepr-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'].'#mepr_jump'; ?>" novalidate>
		    ...
		    <?php else: ?>
		      ...
		      <div class="mp-form-row mepr_email">
		        ...
		        <input type="email" name="user_email" placeholder="Email Address" id="user_email<?php echo $unique_suffix; ?>" class="mepr-form-input" value="<?php echo (isset($user_email))?esc_attr(stripslashes($user_email)):''; ?>" required />
		      </div>
		      ...
		      <?php if($mepr_options->disable_checkout_password_fields === false): ?>
		        <div class="mp-form-row mepr_password">
		          ...
		          <input type="password" name="mepr_user_password" placeholder="Password" id="mepr_user_password<?php echo $unique_suffix; ?>" class="mepr-form-input mepr-password" value="<?php echo (isset($mepr_user_password))?esc_attr(stripslashes($mepr_user_password)):''; ?>" required />
		        </div>
		        <div class="mp-form-row mepr_password_confirm mb-0">
		          <div class="mp-form-label">
