...
if ( ! function_exists( 'diagrid_pagination' ) ) {
	/**
	 ...
	 */
	function diagrid_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'diagrid' ),
				'next_text'          => __( '&raquo;', 'diagrid' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'diagrid' ),
			)
		);
