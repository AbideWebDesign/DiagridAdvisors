		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7 order-1 order-md-0">
				...
				<div class="d-flex flex-column flex-md-row">
					...
					<div class="align-self-center text-center text-md-left">© <?php echo date('Y'); ?> Diagrid Advisors. All Rights Reserved.<br><a href="https://abidewebdesign.com" target="_blank">Website Design and Maintenance by Abide Web Design</a></div>
